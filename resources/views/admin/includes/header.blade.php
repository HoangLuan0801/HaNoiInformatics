			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="{{ route('manager_file') }}"> Quản lý file đính kèm</a></li>
						<li><a href="/admin/category"> Quản lý chuyên mục</a></li>
						<li><a href="{{ route('manager_sciencestudy') }}"> Quản lý đề tài khoa học</a></li>
						<li><a href="{{ route('manager_faculty') }}"> Quản lý khoa</a></li>
						<li><a href="{{ route('manager_document') }}"> Quản lý văn bản</a></li>
						<li><a href="{{ route('manager_documenttype') }}"> Quản lý tài liệu</a></li>
