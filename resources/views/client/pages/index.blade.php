      ...
      <div class="container">
        ...
        <div class="feature-grid">
          <div class="col-md-4 feature-grid">
            ...
            <a href="single.html"><img src="{{url('/')}}/client_assets/images/pc.jpg" class="img-responsive" alt=""></a>
          ...
          <div class="col-md-4 feature-grid">
            ...
            <a href="single.html"><img src="{{url('/')}}/client_assets/images/pc1.jpg" class="img-responsive" alt=""></a>
            <a href="single.html" class="read"> Read More</a>
          </div>
          <div class="col-md-4 feature-grid">
            <h5><a href="single.html">Consectetur adipisicing</a></h5>
            ...
            <a href="single.html"><img src="{{url('/')}}/client_assets/images/pc2.jpg" class="img-responsive" alt=""></a>
            <a href="single.html" class="read"> Read More</a>
          </div>
          <div class="clearfix"> </div> 
        </div>
